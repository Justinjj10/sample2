...
#import "enterd_cel.h"
#import "non_entered_cel.h"

#import "MXSegmentedPager.h"


@interface travel_list ()<MXSegmentedPagerDelegate, MXSegmentedPagerDataSource, UITableViewDelegate, UITableViewDataSource>
{
...
- (NSString *)segmentedPager:(MXSegmentedPager *)segmentedPager titleForSectionAtIndex:(NSInteger)index {
    return @[@"Entered List", @"Non Entered List"][index];
}
...
-(BOOL)urlList_Requesttri
{
    ...
    NSString *urlString =[NSString stringWithFormat:@"http://app.sponsormasterqatar.com/index.php/VisaApi/visaenteredlist?admin_id=1&Authorization=%@&start=0&limit=50",self.ss];
...
-(BOOL)urlList_Requesttri1
{
    ...
    NSString *urlString =[NSString stringWithFormat:@"http://app.sponsormasterqatar.com/index.php/VisaApi/visanotenteredlist?admin_id=1&Authorization=%@&start=0&limit=50",self.ss];
...

{
    if (tableView==_tableView) {
        ...
        cell=[self.eneterd_tabl dequeueReusableCellWithIdentifier:CellIdentifier];
        
        
        if (cell==nil) {
            NSArray*toplevelobject=[[NSBundle mainBundle] loadNibNamed:@"enterd_cel" owner:self options:nil];
        ...
        NSString *s2=[[[Dict  objectForKey:@"visa_list"]valueForKey:@"visa_number"] objectAtIndex:indexPath.section];
        
        NSString *s3=[[[Dict  objectForKey:@"visa_list"]valueForKey:@"visa_client_name"] objectAtIndex:indexPath.section];
        
//        
//        NSString *sm=[NSString stringWithFormat:@"%@",[[Dict  objectForKey:@"visa_list"]valueForKey:@"visa_category"]];
//        
...
//        [arr addObject:sm];
       ...
       NSString *s5=[[[Dict  objectForKey:@"visa_list"]valueForKey:@"visa_type_name"] objectAtIndex:
                      
                      indexPath.section];
        
        
        
        NSString *s6=[[[Dict  objectForKey:@"visa_list"]valueForKey:@"visa_entry_date"] objectAtIndex:indexPath.section];
        
        NSString *s7=[[[Dict  objectForKey:@"visa_list"]valueForKey:@"visa_expiry_date"] objectAtIndex:indexPath.section];
 ...
 cell.cliuent_labl.text=s3;
 cell.cat_labl.text=s4;
      cell.type_labl.text=s5;
       cell.entry_labl.text=s6;
        cell.exp_labl.text=s7;
...
#pragma  tabl2
    ...
    else if (tableView==_tableView1)
    {
        ...
        cell1=[self.non_entered_labl dequeueReusableCellWithIdentifier:CellIdentifier1];
        
        
        if (cell1==nil) {
            NSArray*toplevelobject=[[NSBundle mainBundle] loadNibNamed:@"non_entered_labl" owner:self options:nil];
